...
export const PROJECTS: Projects = [
  ...
  },
  {
    ...
    description: "A website made for florence food studio cooking classes and restaurant activities",
  ...
  },
  {
    ...
    type: "image",
    label: "Al Vicolo",
    name: "Al Vicolo Restaurant",
    description: "A website made for 'al vicolo' restaurant",
    technologies: ["NextJS", "TypeScript", "Tailwind CSS", "Vercel"],
    preview: alvicolo,
    repo: null,
    url: "https://alvicolochiavenna.com",
  },
  {
    icon: shadow,
    type: "image",
    ...
    url: "https://box-shadow-generatorr.vercel.app",
  },
  {
    icon: url,
    type: "image",
