  ...
  return (
    <>
      ...
      >
        ...
        >
          <Heading variant={"h1"} align={max.isSm ? "center" : "left"}>
            CIAO, IO SONO
            <br />
          ...
          <P size={"lg"} align={max.isSm ? "center" : "left"}>
            Sono un giovane <span className="font-bold">indipendente</span> e{" "}
            <span className="font-bold">creativo</span> <br />
            sviluppatore full-stack italiano.
          </P>
